...
echo "[2/3] Running layer 3 analysis..."
python "$ROOT_DIR/python/run_layer3_analysis.py"

echo "[3/3] Validating required artifacts..."
python "$ROOT_DIR/python/validate_layer3.py"

echo "E2E Camada 3 completed successfully."
