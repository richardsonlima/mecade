...
echo "[2/3] Running layer 7 analysis..."
python "$ROOT_DIR/python/run_layer7_analysis.py"

echo "[3/3] Validating required artifacts..."
python "$ROOT_DIR/python/validate_layer7.py"

echo "E2E Camada 7 completed successfully."
