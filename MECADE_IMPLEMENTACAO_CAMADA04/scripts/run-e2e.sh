...
echo "[2/3] Running layer 4 analysis..."
python "$ROOT_DIR/python/run_layer4_analysis.py"

echo "[3/3] Validating required artifacts..."
python "$ROOT_DIR/python/validate_layer4.py"

echo "E2E Camada 4 completed successfully."
